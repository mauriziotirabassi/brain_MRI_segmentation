...
% xy 'axial' (third dimension of vol) plane intersting slices: from 60 to 90
% yz 'coronal' second dimension of vol) plane interesting slices: from 140 to 180
% xz 'sagittal' (first dimension of vol) plane interesting slices: from 100 to 145
sg=rot90(permute(squeeze(vol(100:145,:,:)),[2,3,1]));
ax=rot90(squeeze(vol(:,:,60:90)));
cr=rot90(permute(squeeze(vol(:,140:180,:)),[1,3,2]));
